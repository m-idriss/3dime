...
- Ignoring or dismissing concerns about accessibility or inclusivity
...
- **Email**: contact@3dime.com (monitored regularly)
- **GitHub Issues**: For non-sensitive matters, create an issue with the label `conduct`
- **Direct Contact**: [@m-idriss](https://github.com/m-idriss) on GitHub
...
1. **Contacting** the repository owner at contact@3dime.com within 30 days
2. **Providing** a clear explanation of why you believe the decision was unfair
3. **Including** any relevant evidence or context
4. **Waiting** for a response within 14 days
...
**Together, let's build a welcoming and inclusive community! 🌟**